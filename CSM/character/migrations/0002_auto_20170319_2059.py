...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='characters', to='rules.Background'),
        ),
        migrations.AddField(
            model_name='character',
            name='char_classes',
            field=models.ManyToManyField(blank=True, related_name='characters', through='character.ClassLevel', to='rules.Class'),
        ),
        migrations.AddField(
            model_name='character',
            name='char_race',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='characters', to='rules.Race'),
        ),
        migrations.AddField(
            model_name='character',
            name='conditions',
