    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('description', models.CharField(max_length=10000)),
                ('ability_to_change', models.CharField(blank=True, choices=[('Strength', 'Strength'), ('Dexterity', 'Dexterity'), ('Constitution', 'Constitution'), ('Intelligence', 'Intelligence'), ('Wisdom', 'Wisdom'), ('Charisma', 'Charisma')], max_length=64, null=True)),
                ...
                ('spell_choice_constraint_use', models.CharField(blank=True, max_length=512, null=True)),
                ...
                ('armor_prof', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_armor_profs', to='equipment.Armor')),
                ('condition_resistance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_conditions', to='rules.Condition')),
                ('damage_resistance_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_damage_resistance_types', to='rules.DamageType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', models.ManyToManyField(related_name='subrace_languages', to='rules.Language')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_languages', to='rules.Language'),
        ),
        migrations.AddField(
            model_name='feature',
            name='prereq_class',
        ...
        migrations.AddField(
            model_name='feature',
            name='prereq_skill',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_prereq_skill', to='rules.Skill'),
        ),
        migrations.AddField(
            model_name='feature',
            name='skill_prof',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_skill_profs', to='rules.Skill'),
        ),
        migrations.AddField(
            model_name='feature',
            name='spell_choice',
            field=models.ManyToManyField(blank=True, related_name='feature_spells', to='spells.Spell'),
        ),
        migrations.AddField(
            model_name='feature',
            name='tool_prof',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_tool_profs', to='equipment.Tool'),
        ),
        migrations.AddField(
            model_name='feature',
            name='weapon_prof',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_weapon_profs', to='equipment.Weapon'),
        ),
        migrations.AddField(
            model_name='class',
            name='features',
        ...
        migrations.AddField(
            ...
            name='features',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='background_features', to='rules.Feature'),
        ),
        migrations.AddField(
            model_name='background',
            name='item_starts',
