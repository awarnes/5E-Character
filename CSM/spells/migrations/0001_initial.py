# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-07 22:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[(0, 'Cantrip'), (1, '1st-level'), (2, '2nd-level'), (3, '3rd-level'), (4, '4th-level'), (5, '5th-level'), (6, '6th-level'), (7, '7th-level'), (8, '8th-level'), (9, '9th-level')], help_text='Level of the spell.', max_length=1)),
                ('available_to', models.CharField(help_text='Classes that are allowed to cast the spell.', max_length=256)),
                ('cast_time', models.CharField(choices=[('AC', '1 Action'), ('BA', '1 Bonus Action'), ('RE', '1 Reaction'), ('1M', '1 Minute'), ('10', '10 Minutes'), ('1H', '1 Hour'), ('8H', '8 Hours'), ('12', '12 Hours'), ('24', '24 Hours'), ('A8', '1 action or 8 hours')], help_text='Cast time for a spell.', max_length=2)),
