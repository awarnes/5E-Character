    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('space', models.SmallIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='Armor',
            fields=[
                ('item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='equipment.Item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='equipment.Item')),
                ('weapon_type', models.CharField(choices=[('Simple', 'Simple'), ('Martial', 'Martial')], help_text='False = Simple Weapon, True = Martial Weapon.', max_length=16)),
                ('melee_or_ranged', models.CharField(choices=[('Melee', 'Melee'), ('Ranged', 'Ranged')], help_text='False = Melee Weapon, True = Ranged Weapon.', max_length=16)),
